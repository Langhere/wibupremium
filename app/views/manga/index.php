...
Sans One, sans-serif; font-weight: 400; font-style: normal; font-size: x-small;">
    ...
    <div class="flex relative top-20 flex-col sm:flex-row max-w-6xl container mx-auto ">
        <div class="space-y-4 p-2 w-full max-w-[20%] min-w-[10rem] mx-auto">
            <h2 class="lg:text-2xl sm:text-base md:text-lg">Filter by Genre</h2>
        ...
        <div id="products-wrapper"
            ...
            <div class="pop hover:scale-105 border-none transition-all">
                <a class="flex flex-col justify-center relative overflow-hidden group border-b-2 border-slate-700"
                    ...
                    <img src="../slider1.jpg" alt="animek" />
                    <div
